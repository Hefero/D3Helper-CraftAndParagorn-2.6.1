...
namespace Enigma.D3
{
	public class Cinematography : MemoryObject
	{
		...
		public int x04_MouseScrollValue { get { return Read<int>(0x04); } } // Tracked during free camera mode.
		public int x08_Neg1 { get { return Read<int>(0x08); } }
		public float x0C_FreeCameraX { get { return Read<float>(0x0C); } }
		public float x10_FreeCameraY { get { return Read<float>(0x10); } }
		public float x14_FreeCameraZ { get { return Read<float>(0x14); } }
		public float x18_FreeCameraPitch { get { return Read<float>(0x18); } }
		public float x1C_FreeCameraYaw { get { return Read<float>(0x1C); } }
		public float x20_FreeCameraZoom { get { return Read<float>(0x20); } }
		public int x24_MouseX { get { return Read<int>(0x24); } } // Tracked during free camera mode.
		public int x28_MouseY { get { return Read<int>(0x28); } } // Tracked during free camera mode.
		...
		public int x90_StructStart_Min4Bytes { get { return Read<int>(0x90); } }
		...
		public int _xE8 { get { return Read<int>(0xE8); } }
		...
		public class Struct_X48 : MemoryObject
		{
			...
			public float x0C_1f { get { return Read<float>(0x0C); } }
			public float x10_1f { get { return Read<float>(0x10); } }
			public float x14 { get { return Read<float>(0x14); } }
			public float x18 { get { return Read<float>(0x18); } }
			public int x1C_Neg1_FocusedAcdId { get { return Read<int>(0x1C); } }
			public int x20_Neg1 { get { return Read<int>(0x20); } }
			public int x24_Neg1 { get { return Read<int>(0x24); } }
			...
			public int xA8_ObserverSnoId { get { return Read<int>(0xA8); } }
		}
	}
}
